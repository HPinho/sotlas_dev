...
| `island` | ~30% | quarantine/handover agora congelam EXCLUSIVE→ISLAND e ISLAND→EXCLUSIVE explicitamente no graph; aliases/runtime ainda faltam |
...
A combinação ponderada dessas macroentregas coloca a Fase 2 em **~51%**.
