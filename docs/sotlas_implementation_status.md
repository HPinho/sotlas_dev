...
A combinação ponderada dessas macroentregas coloca a Fase 2 em **~64%**.
...
✅ ShareInst/RetainInst placement remains staged until source-stable points exist     ← NOVO
