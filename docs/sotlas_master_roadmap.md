...
- [x] `defer Name;` sobre owner shared possui operação SIR explícita (`DeferUseInst`) e placement antes de ARC em break/continue; payloads de call/assign/block/method/try permanecem fail-closed;
